                                                                                                                                             ...
                                                                                                                                             self.closure(move |rs| {
                                                                                                                                               self.closure(move |teq1| {
                                                                                                                                                 hint_app(match self.CertiCoq_Benchmarks_lib_vs_Superposition_partial_mod(
                                                                                                                                                            ...
                                                                                                                                                            &Coq_Init_Datatypes_sum::inr(_, p) => {
                                                                                                                                                              hint_app(self.closure(move |p2| {
                                                                                                                                                                         self.closure(move |teq2| {
                                                                                                                                                                           hint_app(hint_app(__pair_elim!(
                                                                                                                                                                                               c, p3, {
                                                                                                              ...
                                                                                                              hint_app(match self.Coq_PArith_BinPosDef_Pos_eqb(
                                                                                                                         ...
                                                                                                                         false => {
                                                                                                                           self.closure(move |teq| {
                                                                                                                             hint_app(__pair_elim!(
                                                                                                                                        t, p, {
                                                                                                                                          hint_app(hint_app(self.closure(move |p2| {
                                                                                                                                                              self.closure(move |t2| {
                                                                                                                                                                self.closure(move |teq0| {
                                                                                                                                                                  hint_app(hint_app(__pair_elim!(
                                                                                                                                                                                      t3, p3, {
                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                         self.closure(move |teq12| {
                                                                                                                                                                                                                                                                           self.closure(move |teq03| {
                                                                                                                                                                                                                                                                             hint_app(hint_app(hint_app(hint_app(match s0 {
                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                   &CertiCoq_Benchmarks_lib_vs_Superposition_superposition_result::C_example(_, m, t4) => {
                                                                                                                                                                                                                                                                                                                     hint_app(hint_app(self.closure(move |R| {
                                                                                                                                                                                                                                                                                                                                         self.closure(move |selected| {
                                                                                                                                                                                                                                                                                                                                           self.closure(move |teq3| {
                                                                                                                                                                                                                                                                                                                                             self.closure(move |teq22| {
                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                   &CertiCoq_Benchmarks_lib_vs_Superposition_superposition_result::Aborted(_, l2) => {
                                                                                                                                                                                                                                                                                                                     hint_app(self.closure(move |l3| {
                                                                                                                                                                                                                                                                                                                                self.closure(move |teq3| {
                                                                                                                                                                                                                                                                                                                                  self.closure(move |teq22| {
                                                                                                                                                                                                                                                                                                                                    self.closure(move |teq13| {
                                                                                                                                                                                                                                                                                                                                      self.closure(move |teq04| {
...
fn CertiCoq_Benchmarks_lib_vs_c(&'a self) -> &'a CertiCoq_Benchmarks_lib_vs_expr<'a> {
  self.alloc(
...
fn CertiCoq_Benchmarks_lib_vs_e(&'a self) -> &'a CertiCoq_Benchmarks_lib_vs_expr<'a> {
  self.alloc(
    CertiCoq_Benchmarks_lib_vs_expr::Var(
      PhantomData,
      __pos_onebit(
...
fn CertiCoq_Benchmarks_lib_vs_a(&'a self) -> &'a CertiCoq_Benchmarks_lib_vs_expr<'a> {
  self.alloc(
    CertiCoq_Benchmarks_lib_vs_expr::Var(
      PhantomData,
      1))
...
fn CertiCoq_Benchmarks_lib_vs_b(&'a self) -> &'a CertiCoq_Benchmarks_lib_vs_expr<'a> {
  self.alloc(
    CertiCoq_Benchmarks_lib_vs_expr::Var(
      PhantomData,
      __pos_zerobit(
...
fn CertiCoq_Benchmarks_lib_vs_d(&'a self) -> &'a CertiCoq_Benchmarks_lib_vs_expr<'a> {
  self.alloc(
    CertiCoq_Benchmarks_lib_vs_expr::Var(
      PhantomData,
      __pos_zerobit(
...
fn CertiCoq_Benchmarks_lib_vs_example_ent(&'a self) -> &'a CertiCoq_Benchmarks_lib_vs_entailment<'a> {
  self.alloc(
          ...
          self.alloc(
            Coq_Init_Datatypes_list::cons(
              ...
              self.alloc(
                CertiCoq_Benchmarks_lib_vs_pn_atom::Nequ(
                  PhantomData,
                  self.CertiCoq_Benchmarks_lib_vs_c(),
                  self.CertiCoq_Benchmarks_lib_vs_e())),
              self.alloc(
                Coq_Init_Datatypes_list::nil(
                  PhantomData)))),
          self.alloc(
            Coq_Init_Datatypes_list::cons(
              ...
              self.alloc(
                CertiCoq_Benchmarks_lib_vs_space_atom::Lseg(
                  PhantomData,
                  self.CertiCoq_Benchmarks_lib_vs_a(),
                  self.CertiCoq_Benchmarks_lib_vs_b())),
              self.alloc(
                Coq_Init_Datatypes_list::cons(
                  PhantomData,
                  self.alloc(
                    ...
                    Coq_Init_Datatypes_list::cons(
                      ...
                      self.alloc(
                        CertiCoq_Benchmarks_lib_vs_space_atom::Next(
                          PhantomData,
                          self.CertiCoq_Benchmarks_lib_vs_c(),
                          self.CertiCoq_Benchmarks_lib_vs_d())),
                      self.alloc(
                        Coq_Init_Datatypes_list::cons(
                          PhantomData,
                          self.alloc(
...
fn CertiCoq_Benchmarks_rust_tests_vs_easy(&'a self) -> bool {
  hint_app(hint_app({ let loop = self.alloc(std::cell::Cell::new(None));
                      loop.set(Some(
                        self.closure(move |n| {
                          self.closure(move |res| {
                            __nat_elim!(
                              {
                                match res {
                              ...
                              n2, {
                                let res2 =
                                  self.CertiCoq_Benchmarks_lib_vs_VeriStar_check_entailment(
                                    self.CertiCoq_Benchmarks_lib_vs_example_ent());
                                hint_app(hint_app(loop.get().unwrap())(n2))(res2)
                              },
                              n)
                          })
                        })));
                      loop.get().unwrap() })(__nat_succ(
                                               __nat_succ(
                                                 __nat_succ(
                                                   __nat_succ(
                                                     __nat_succ(
